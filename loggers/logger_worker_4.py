...
def get_worker_4_logger():
    """
    Configures and returns a Logger object.
    The logger is set up to write debug-level
    messages to
    """
    logger_worker_4 = logging.getLogger(__name__)
    logger_worker_4.setLevel(logging.DEBUG)
    log_file_path = LOG_DIR / "worker4.log"
    ...
    logger_worker_4.addHandler(file_handler)
    return logger_worker_4
