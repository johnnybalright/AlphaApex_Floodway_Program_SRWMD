...
def get_worker_1_logger():
    """
    Configures and returns a Logger object.
    The logger is set up to write debug-level
    messages to
    """
    logger_worker_1 = logging.getLogger(__name__)
    logger_worker_1.setLevel(logging.DEBUG)
    log_file_path = LOG_DIR / "worker1.log"
    ...
    logger_worker_1.addHandler(file_handler)
    return logger_worker_1
